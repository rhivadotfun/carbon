    ...
    pub fn from_parts(
        ...
        Self {
            ...
            name: match &source {
                ...
                CpiEvent::CollectUserFeeEvent(_) => "collect_user_fee_event".to_string(),
                CpiEvent::SwapCompletedEvent(_) => "swap_completed_event".to_string(),
            },
...
impl carbon_core::postgres::operations::Delete for CpiEventRow {
    ...
    async fn delete(key: Self::Key, pool: &sqlx::PgPool) -> carbon_core::error::CarbonResult<()> {
        sqlx::query(
            r#"DELETE FROM zap_cpi_events WHERE
...
impl carbon_core::postgres::operations::Lookup for CpiEventRow {
    ...
    async fn lookup(
        ...
        let row = sqlx::query_as(
            r#"SELECT * FROM zap_cpi_events WHERE
            __signature = $1 AND __instruction_index = $2 AND __stack_height = $3
        "#,
        )
        .bind(key.0)
...
impl sqlx_migrator::Operation<sqlx::Postgres> for CpiEventMigrationOperation {
    async fn up(
        ...
        sqlx::query(
            r#"CREATE TABLE IF NOT EXISTS zap_cpi_events (
            -- Instruction data
            "name" TEXT NOT NULL,
            "data" JSONB NOT NULL,
    ...
    async fn down(
        ...
        sqlx::query(r#"DROP TABLE IF EXISTS zap_cpi_events"#)
            .execute(connection)
            .await?;
        Ok(())
    }
